...
//       // console.log("HERE BOY", result.rows[0].sess);
...
//   // Audit how this data is being store
//   async set(sid, sess, maxAge) {
//     // console.log("Here is the sess", sess.cookie);
//     // console.log("here is expires", sess._expires);
//     // console.log("here is maxAge", maxAge());
//     try {
//       const result = await query(
//         "INSERT INTO session (sid, sess, expire) VALUES ($1, $2, $3) ON CONFLICT (sid) DO UPDATE SET sess = $2, expire = $3",
//         [sid, JSON.stringify(sess), sess.cookie._expires]
